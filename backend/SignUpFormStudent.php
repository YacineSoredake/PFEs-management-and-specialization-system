...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["register"])) {
    ...
    if (!$recaptchaResultJson["success"]) {
        ...
        $niveau = isset($_POST['level']) ? $_POST['level'] : "";
        ...
        // Insert etudient data with the user id
        $req1 = "INSERT INTO etudient(nompre, id,niveau, specialite, datenaissance, image, id_user) VALUES('$name','$number' ,'$niveau', '$specialite', '$naissance', '$photo', '$userId')";
