...
if (isset($_POST['refresh'])) {
    $excelFilePath = 'C:\Users\USER\OneDrive\Bureau\PFEs - Copie\excel\licence_Student_Ranking.xlsx'; // Adjust this path
...
$query = "SELECT id,nompre,ranking FROM etudient WHERE niveau = '3L'";
        ...
        <div class="menubar">
            ...
            <div>
                <nav>
                    ...
                    <a href="/adminpanel/listeFinish/rankingMaaster.php">
                    <img style="height: 15px;" src="/PFEs/figma/sub.svg" alt="">
                        2nd master
                    </a>
